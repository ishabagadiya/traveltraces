...
const Destinations = () => {
  ...
  return (
    <section className="flex flex-col items-center justify-center mt-[140px]">
      <div
        className="relative ml-auto mt-[55px] overflow-hidden w-[80%] sm:w-[80%] h-[calc(100vh-300px)] sm:h-[calc(100vh-200px)] flex items-center justify-center rounded-xl sm:rounded-2xl shadow-lg"
